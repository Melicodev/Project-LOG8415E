...
class Instances:
    ...
    def create_n_instances(self, n, type, security_groups):
        """create the ec2 t2.micro instances representing the workers
    ...
    def setup(self, n, type):
        ...
        self.create_n_instances(n, type, security_groups)
